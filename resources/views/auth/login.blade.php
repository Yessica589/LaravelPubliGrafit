@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Publigrafit')])
                    ...
                    <div class="card-body">
                        ...
                        <div class="bmd-form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                            <div class="input-group">
                                ...
                                <input type="text" name="username" class="form-control" placeholder="{{ __('Nombre de usuario o E-mail...') }}"
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <a href="{{ route('password.request') }}" class="text-light">
                        <small>{{ __('¿Has olvidado tu contraseña?') }}</small>
                    </a>
                    @endif
                </div>
